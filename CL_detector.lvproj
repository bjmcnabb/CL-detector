...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="CL" Type="Folder">
			<Item Name="SubVIs" Type="Folder">
				<Item Name="Compass.ctl" Type="VI" URL="../SubVIs/Compass.ctl"/>
				<Item Name="ConsumeBefore.vi" Type="VI" URL="../SubVIs/ConsumeBefore.vi"/>
				<Item Name="elapsed_sec_to_timestamp.vi" Type="VI" URL="../SubVIs/elapsed_sec_to_timestamp.vi"/>
				<Item Name="Julian Day_with_millisec_BM_subVI.vi" Type="VI" URL="../SubVIs/Julian Day_with_millisec_BM_subVI.vi"/>
				<Item Name="Read NMEA GPS GENERIC - no error - SubVI.vi" Type="VI" URL="../SubVIs/Read NMEA GPS GENERIC - no error - SubVI.vi"/>
				<Item Name="Read_generic_GPS_subVI.vi" Type="VI" URL="../SubVIs/Read_generic_GPS_subVI.vi"/>
				<Item Name="Retrieve Token String.vi" Type="VI" URL="../SubVIs/Retrieve Token String.vi"/>
			</Item>
			<Item Name="BM_Detect_Integrate_Peaks.vi" Type="VI" URL="../BM_Detect_Integrate_Peaks.vi"/>
			<Item Name="Chemiluminescence_VI_BM.vi" Type="VI" URL="../Chemiluminescence_VI_BM.vi"/>
		</Item>
